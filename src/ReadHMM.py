...
from Structure import Syllable
from Structure import Mixture
...
piArr = []
stateList =[]
sylList = [0]*21    # save all syllables
        ...
        if cur == 3:                            #parse pi & a
            ...
            if(stateNum == 3):
                ...
                if i == 0:              #form pi
                    ...
                    aArr = []                       # aArr = 2*2 array // initialize
                    for x in range(transCnt-1):
                        aArr.append([0.0]*(transCnt-1))
                    i = i+1
                
                elif (i<transCnt-1):
                    for tempI in range(1,3):
                        aArr[i-1][tempI-1] = temp[tempI]
                    i = i+1
                else:
                    syllable.aArr_Pi(aArr, piArr)
